...
def detection(video, stream, fps, scale):
    ...
    for frame in manager_cv2:
        if manager_cv2.key_manager.detect:
            ...
            # So I will recalculate de detection each 10 frames
            ...
            if manager_cv2.count_frames % 10 == 1:
                selector = face_detector(frame, scale)
...
if __name__ == '__main__':
    ...
    detection(args.video, args.stream, args.fps, args.scale)
